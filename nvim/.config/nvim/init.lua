...
vim.o.softtabstop = 4 -- A tab key press inserts 4 spaces
...
-- Diagnostic keymaps
vim.keymap.set("n", "]d", jump(1), { desc = "Go to next [D]iagnostic message" })
vim.keymap.set("n", "[d", jump(-1), { desc = "Go to previous [D]iagnostic message" })
